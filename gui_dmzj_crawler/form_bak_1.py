        ...
        if '很遗憾，您搜索的内容暂时没有找到。' in result_search.text:
            ...
            for self.i_page_search in range(0, len(page_search)):
                ...
                for self.i_comic in range(0, len(self.title_search)):
                    self.i_comic_sum = self.i_comic_sum + self.i_comic
                    ...
                    text_search_label = '<html><head/><body><p><span style=" color:#0000ff;">' + str(self.i_comic_sum) + '   ' + self.title_search[self.i_comic] + '</span></p></body></html>'
